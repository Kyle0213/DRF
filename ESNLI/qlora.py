...
save = './qwen_2e'
ch2l = load_dataset("json", data_files="./esnli_change_deepseek.json")
learningrate = 2e-5
...
def preprocess_function1(examples):
    ...
    for context, hypothesis, thought, label in zip(
        examples['content'], examples['hypothesis'], examples['ch2l_[Thought]'], examples['gold_label']
    ):
        prompt = f"""
...
def preprocess_function2(examples):
    ...
    for context, hypothesis, thought, label,chl2m_reason,chl2m_sentences,chl2m_method in zip(
        examples['content'], examples['hypothesis'], examples['ch2l_[Thought]'], examples['gold_label'],examples['chl2m_[Thought]'],examples['chl2m_[sentence]'],examples['chl2m_[Method]']    
        ):
        prompt = f"""
...
def preprocess_function3(examples):
    ...
    for context, label, thought, hypothesis,method_reason,method_sentence,method in zip(
        examples['content'], examples['gold_label'], examples['lm2h_[Thought]'], examples['hypothesis'],examples['chl2m_[Thought]'],examples['chl2m_[sentence]'],examples['chl2m_[Method]']
    ):
        prompt = f"""
